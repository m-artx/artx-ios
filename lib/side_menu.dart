...
class SideMenu extends StatelessWidget {
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CartPage()), // Replace CartPage with the name of your cart page class
                      );
                    },
                  ),
                ],
            ...
            Transform.translate(
              ...
              child: Column(
                children: [
                  ...
                  _buildMenuItem(context, '마이페이지', subItems: [
                    '내 프로필',
                    '개인정보 관리',
                    '주문/배송정보',
                    '배송지 관리',
  ...
  Widget _buildMenuItem(BuildContext context, String title,
    ...
    TextStyle mainMenuStyle = TextStyle(
        color: Colors.white, fontFamily: 'EliceDXNeolli', fontSize: 17);
    TextStyle subMenuStyle = TextStyle(
        color: Colors.white, fontFamily: 'EliceDXNeolli', fontSize: 15);
